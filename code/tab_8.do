...
*
* This file is the RUNNER. Shiny merges it with stata/maketable8.do for a
...
* Analysis is in stata/maketable8.do (shown in full in the Code tab).
quietly do "${maindir}/stata/maketable8.do"
