...
*
* This file is the RUNNER. Shiny merges it with code/maketable6.do for a
...
* Analysis is in code/maketable6.do (shown in full in the Code tab).
quietly do "${maindir}/code/maketable6.do"
