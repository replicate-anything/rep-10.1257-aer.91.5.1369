...
*
* This file is the RUNNER. Shiny merges it with stata/maketable2.do for a
...
* Analysis is in stata/maketable2.do (shown in full in the Code tab).
quietly do "${maindir}/stata/maketable2.do"
