...
*
* This file is the RUNNER. Shiny merges it with code/maketable2.do for a
...
* Analysis is in code/maketable2.do (shown in full in the Code tab).
quietly do "${maindir}/code/maketable2.do"
