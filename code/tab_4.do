...
*
* This file is the RUNNER. Shiny merges it with code/maketable4.do for a
...
* Analysis is in code/maketable4.do (shown in full in the Code tab).
quietly do "${maindir}/code/maketable4.do"
