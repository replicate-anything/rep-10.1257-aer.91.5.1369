...
*
* This file is the RUNNER. Shiny merges it with stata/maketable4.do for a
...
local oldpwd "`c(pwd)'"
cd "${result}"
log using "tab_4_stata", replace text

* Analysis is in stata/maketable4.do (shown in full in the Code tab).
quietly do "${maindir}/stata/maketable4.do"
