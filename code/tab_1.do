...
*
* This file is the RUNNER. Shiny merges it with code/maketable1.do for a
...
* Analysis is in code/maketable1.do (shown in full in the Code tab).
quietly do "${maindir}/code/maketable1.do"
