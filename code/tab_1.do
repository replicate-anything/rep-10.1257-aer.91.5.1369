...
*
* This file is the RUNNER. Shiny merges it with stata/maketable1.do for a
* single copy-paste script. To run manually from the study repo root:
*   do "code/tab_1.do"
*
* ============================================================
* SETUP — paths (edit maindir if you run from elsewhere)
* ============================================================
version 17
...
* Analysis is in stata/maketable1.do (shown in full in the Code tab).
quietly do "${maindir}/stata/maketable1.do"
