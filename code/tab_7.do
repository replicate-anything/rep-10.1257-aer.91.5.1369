...
*
* This file is the RUNNER. Shiny merges it with stata/maketable7.do for a
...
local oldpwd "`c(pwd)'"
cd "${result}"
log using "tab_7_stata", replace text

* Analysis is in stata/maketable7.do (shown in full in the Code tab).
quietly do "${maindir}/stata/maketable7.do"
