...
*
* This file is the RUNNER. Shiny merges it with code/maketable7.do for a
...
* Analysis is in code/maketable7.do (shown in full in the Code tab).
quietly do "${maindir}/code/maketable7.do"
